...
- Der Kollisions-Hinweis bei manuellem `main/cmd ON` sowie die Touch-UI-Anzeige/-Bedienung für den Zeitplan wurden am 2026-08-17 komplett verworfen, nicht nur zurückgestellt (siehe Abschnitt „Verworfen" oben bzw. `docs/spec/13-touch-ui.md`) — Zeitplan-Bearbeitung bleibt dem geplanten Web-Interface vorbehalten (Display zu klein für eine sinnvolle Bedienung).
