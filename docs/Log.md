...
- **Backend-Logging-Review** — laeuft, Datei fuer Datei: `WifiManager.cpp`, `WebManager.cpp`, `ValveController.cpp` abgeschlossen. Noch offen: `MqttManager.cpp` (groesste Datei), `HmiManager.cpp`, `main.cpp` (kurzer Abschlussdurchgang).
