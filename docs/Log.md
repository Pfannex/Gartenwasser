...
- **Phase 16 (Web-Interface-Fundament)** — nächster Arbeitsschritt: Architekturfrage (A/B, siehe oben) im Interview mit dem Nutzer klären, dann Fundament umsetzen.
- Phasen 17–21 (Web-Interface: Dashboard, Konfiguration, Programme, Zeitplan, OTA) — geplant, hängen an Phase 16.
