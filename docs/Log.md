...
- **Usermanual**: Grundgeruest fertig (`manual/usermanual.md` + HTML-Artefakt), siehe oben. Offen: WebIF-Seiten-Screenshots (Nutzer liefert sie), danach in beide Fassungen einpflegen. Home-Assistant-Kapitel bleibt Platzhalter bis Phase 10 abgeschlossen ist.
