...
- **Usermanual**: inhaltlich fertig (alle Kapitel bebildert, Topic-Baum als echter CSS-Verzeichnisbaum), siehe oben. **Ungeloest**: Bild-Umbruch-Bug beim Nutzer weiterhin reproduzierbar trotz bestaetigt korrektem Live-CSS und bestaetigtem Hard-Reload - Ursache unklar, naechster Schritt ist die Abfrage des genauen Browsers/Version beim Nutzer. Home-Assistant-Kapitel bleibt Platzhalter bis Phase 10 abgeschlossen ist.
