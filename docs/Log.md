...
- **Vollständiges Usermanual** (Nutzerwunsch 2026-08-19): Hardware-Beschreibung, Schaltpläne (inkl. MCP23017), Bedienungsanleitung WebIF/HMI/MQTT, als `.md` und `.pdf` - eigenes Kapitel für Home Assistant (Platzhalter, wird nach Phase 10 ergänzt). WebIF-Seiten-Screenshots noch offen (kein Browser-Zugriff in dieser Umgebung, Nutzer stellt sie zur Verfügung). Direkt vor Phase 10 eingeschoben.
