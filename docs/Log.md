...
- **Usermanual**: inhaltlich fertig (alle Kapitel bebildert, Topic-Baum als echter CSS-Verzeichnisbaum), siehe oben. **Noch nicht abschliessend verifiziert**: Bild-Umbruch-Bug beim Nutzer (Chrome) - zusaetzliche `display:table`-Verteidigungslinie ergaenzt und veroeffentlicht, Rueckmeldung des Nutzers nach erneutem Testdruck steht noch aus. Home-Assistant-Kapitel bleibt Platzhalter bis Phase 10 abgeschlossen ist.
