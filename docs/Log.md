...
- **Usermanual**: Kapitel 1–5, 6.1–6.3 und 7 mit echten Fotos/vollstaendigem Topic-Baum, siehe oben. Offen: Screenshots fuer Zeitplan/Log/Update/Info (Kapitel 6.4–6.7, Demo-Zeitplan liegt bereits auf dem Geraet bereit) sowie ein Verkabelungsfoto (Kapitel 3). Home-Assistant-Kapitel bleibt Platzhalter bis Phase 10 abgeschlossen ist.
